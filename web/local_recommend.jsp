...
<html>
	...
	<script >
	jQuery(function(){
		$("#artist").autocomplete("auto_list1.jsp");
	});
   </script>
    ...
    <body>
        ...
        <div align="center">
        <form action="ActionServlet" class ="navbar-form" method="post" role="form" >
            <input type="text" id="artist" name="song" class="form-control input-sm" placeholder="Enter song" />
